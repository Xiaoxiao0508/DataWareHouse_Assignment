...
INSERT INTO ERROREVENT
(SOURCE_ID,SOURCE_TABLE,FILTERID,[DATETIME],[ACTION])
SELECT SM.Saleid, 'SALEBRIS', 8, (SELECT GETDATE()), 'SKIP'
FROM TPS.dbo.SALEBRIS SM
...
INSERT INTO ERROREVENT
(SOURCE_ID,SOURCE_TABLE,FILTERID,[DATETIME],[ACTION])
SELECT SM.Custid, 'SALEBRIS', 9,  GETDATE(), 'SKIP'
FROM TPS.dbo.SALEBRIS SM
WHERE SM.Custid NOT IN (
    ...
    INNER JOIN
    TPS.dbo.SALEBRIS SM
    ON SM.Custid =DW.DWSOURCEIDBRIS
)
...
INSERT INTO ERROREVENT
(SOURCE_ID,SOURCE_TABLE,FILTERID,[DATETIME],[ACTION])
SELECT SM.Saleid, 'SALEBRIS', 10,  GETDATE(), 'MODIFY'
FROM TPS.dbo.SALEBRIS SM
...
INSERT INTO ERROREVENT
(SOURCE_ID,SOURCE_TABLE,FILTERID,[DATETIME],[ACTION])
SELECT SM.Saleid, 'SALEBRIS', 11,  GETDATE(), 'MODIFY'
FROM TPS.dbo.SALEBRIS SM
...
SM.QTY, 
(SELECT DD.DATEKEY FROM DWDATE DD WHERE SM.saledate = DD.Datevalue), 
((SELECT DD.DATEKEY FROM DWDATE DD WHERE SM.SHIPDATE = DD.Datevalue)+2), 
SM.UNITPRICE
FROM TPS.DBO.SALEBRIS SM
INNER JOIN ERROREVENT EE
ON SM.Saleid=EE.SOURCE_ID
WHERE EE.FILTERID=10
-- SELECT*
-- FROM DWSALE
...
-- FROM TPS.DBO.SALEBRIS SM
-- -- 
-- WHERE SM.SALEID IN (SELECT EE.SOURCE_ID FROM ERROREVENT EE WHERE EE.SOURCE_TABLE = 'SALEBRIS' )
...
(SELECT Max(Unitprice) FROM TPS.dbo.SALEBRIS WHERE Unitprice in (SELECT Unitprice  FROM TPS.dbo.SALEBRIS SM2 where SM2.Prodid=SM.Prodid))

FROM TPS.DBO.SALEBRIS SM
where  SM.Saleid IN (SELECT EE.SOURCE_ID
FROM ERROREVENT EE
WHERE EE.FILTERID=11)


-- select max(SM.unitprice) AS MaxPrice, SM.Prodid FROM TPS.DBO.SALEBRIS SM WHERE SM.Prodid IN(
-- SELECT SM.Prodid FROM TPS.DBO.SALEBRIS SM
-- INNER JOIN ERROREVENT EE
-- ON SM.Saleid=EE.SOURCE_ID
-- where EE.FILTERID=11)
-- GROUP BY SM.Prodid
...
-- ///////////////////////////////////////////////////Task6.1///////////////////////////
-- SALEID 11294,11316,11351
INSERT INTO ERROREVENT
(SOURCE_ID,SOURCE_TABLE,FILTERID,[DATETIME],[ACTION])
SELECT SM.Saleid, 'SALEMELB', 12, (SELECT GETDATE()), 'SKIP'
...
INSERT INTO ERROREVENT
(SOURCE_ID,SOURCE_TABLE,FILTERID,[DATETIME],[ACTION])
SELECT SM.Custid, 'SALEMELB', 13,  GETDATE(), 'SKIP'
FROM TPS.dbo.SALEMELB SM
WHERE SM.Custid NOT IN (
...
INSERT INTO ERROREVENT
(SOURCE_ID,SOURCE_TABLE,FILTERID,[DATETIME],[ACTION])
SELECT SM.Saleid, 'SALEMELB', 14,  GETDATE(), 'MODIFY'
FROM TPS.dbo.SALEMELB SM
WHERE SM.Shipdate<SM.Saledate
...
INSERT INTO ERROREVENT
(SOURCE_ID,SOURCE_TABLE,FILTERID,[DATETIME],[ACTION])
SELECT SM.Saleid, 'SALEMELB', 15,  GETDATE(), 'MODIFY'
FROM TPS.dbo.SALEMELB SM
WHERE SM.Unitprice IS NULL
...
SM.UNITPRICE
FROM TPS.DBO.SALEMELB SM
WHERE SM.Saleid IN(SELECT EE.SOURCE_ID FROM ERROREVENT EE WHERE EE.FILTERID=14 AND EE.SOURCE_TABLE='SALEMELB')
...
(SELECT Max(Unitprice) FROM TPS.dbo.SALEMELB WHERE Unitprice in (SELECT Unitprice from TPS.dbo.SALEMELB SM2 where SM2.Prodid=SM.Prodid)
)
FROM TPS.DBO.SALEMELB SM
where  SM.Saleid IN (SELECT EE.SOURCE_ID FROM ERROREVENT EE WHERE EE.FILTERID=15)
AND SM.Saleid NOT IN (SELECT EE.SOURCE_ID FROM ERROREVENT EE WHERE EE.SOURCE_TABLE='SALEMELB' GROUP BY EE.SOURCE_ID HAVING COUNT(*) > 1)
-- //////////////////////////////////////////TASK 7.1///////////////////////////
...
-- SELECT * FROM DWSALE DS
-- WHERE DS.DWSOURCEIDMELB IN (
--     SELECT EE.SOURCE_ID FROM ERROREVENT EE GROUP BY EE.SOURCE_ID HAVING COUNT(*)>1
-- )
-- SELECT * FROM DWSALE DS
-- WHERE DS.DWSOURCEIDBRIS IN (
--     SELECT EE.SOURCE_ID FROM ERROREVENT EE GROUP BY EE.SOURCE_ID HAVING COUNT(*)>1
-- )