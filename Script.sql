...
-- /////////////////////////////////////////TASK 2.4.5/////////////////////////
INSERT INTO  DWPROD(DWSOURCEID,PRODNAME,PRODCATNAME,PRODMANUNAME,PRODSHIPNAME)
SELECT PR.Prodid, PR.Prodname, PC.CATEGORYNAME, M.Manuname, SH.DESCRIPTION
FROM TPS.dbo.PRODUCT PR
    LEFT JOIN
    TPS.dbo.PRODCATEGORY PC
...
-- FROM GENDERSPELLING
-- )
-- Select * from DWCUST,  GENDERSPELLING  where DWCUST.GENDER=GENDERSPELLING.[Invalid Value] 
-- update DWCUST 
-- set DWCUST.GENDER=GENDERSPELLING.[New Value]
-- SELECT *
-- FROM GENDERSPELLING